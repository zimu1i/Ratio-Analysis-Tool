...
profile = st.selectbox("Select investor profile:", list(investor_profiles.keys()))  # added profile input
weights = investor_profiles[profile]  # weights for profile
